...
- Issue を新規作成するとき
- 他のアジャイルスキル（`/agile-epic`, `/agile-create-stories`, `/agile-refine-implementation-plan`, `/agile-implementation-plan-to-task`）から呼び出されるとき
