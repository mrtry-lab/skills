...
metadata:
    github-path: skills/agile-create-epic
    github-ref: refs/heads/main
    github-repo: https://github.com/mrtry-lab/skills
    github-tree-sha: 6006ea18b8ae664b5333d3b3fbb5334c673df9a9
...
| 状況 | 対応 |
|------|------|
| VISION.mdが存在しない | 「先にビジョンを策定しましょう」と `/agile-craft-vision` に誘導 |
...
| VISION.mdのフォーマットが想定と異なる | Layer 3（What）相当の情報を対話で補完する。フォーマット修正は `/agile-craft-vision` に委ねる |
